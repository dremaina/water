...
if (!sessionStorage.getItem('user_id') || sessionStorage.getItem('role') !== 'customer') {
                            ...
                            ${order.items.map(item => `
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <small class="text-muted">Kes ${item.price_per_unit} × ${item.quantity}</small>
                                    </div>
                                    <div class="ms-auto">
                                        <span class="text-primary">Kes ${item.subtotal}</span>
                                    </div>
                                </div>
                            `).join('')}
                        </div>
                        <div class="border-top pt-3">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-md-end">
                                    <h6>Total Amount:</h6>
                                    <h5 class="text-primary mb-0">Kes ${order.total_amount}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
