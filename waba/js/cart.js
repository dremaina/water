...
function updateCartUI(data) {
    ...
    if (!data.items.length) {
        ...
        cartTotal.innerHTML = 'Kes 0.00';
        cartTotal2.innerHTML = 'Kes 0.00';
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <div class="quantity-control">
                        ...
                        <button class="btn btn-sm btn-outline-primary" onclick="updateQuantity(${item.id}, Number(${item.quantity + 1}))">
...
function generatePDF(receipt) {
    ...
    receipt.items.forEach(item => {
        ...
        doc.text(String(parseFloat(item.quantity)), 100, y);
