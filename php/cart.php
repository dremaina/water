...
class Cart {
    ...
    public function initiatePayment($orderId, $phoneNumber) {
        try {
            ...
            $this->simulatePaymentSuccess($transactionId);
    ...
    private function simulatePaymentSuccess($transactionId) {
        ...
        try {
            ...
            $query = "UPDATE " . $this->orders_table . " o
                    JOIN " . $this->mpesa_table . " m ON o.id = m.order_id
    ...
    public function generateReceipt($orderId) {
        ...
        try {
            ...
            $query = "SELECT o.*, u.full_name, u.email, u.phone,
                    m.transaction_id as mpesa_transaction
                    FROM " . $this->orders_table . " o
